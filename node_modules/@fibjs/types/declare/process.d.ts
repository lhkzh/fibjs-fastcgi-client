...
declare module "process" {
	...
	module process {
		 ...
		 * @async
		 */
		export function run(command: string, args: any[], opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?: Fibjs.AsyncCallback<number>/** = function (err: Error, result: number) {}*/): number;
		 ...
		 * @async
		 */
		export function run(command: string, opts?: Fibjs.AnyObject/** = v8::Object::New(isolate)*/, callback?: Fibjs.AsyncCallback<number>/** = function (err: Error, result: number) {}*/): number;
